...
-- 테이블 데이터 springgreen.books:~5 rows (대략적) 내보내기
DELETE FROM `books`;
...
-- 테이블 데이터 springgreen.guest:~35 rows (대략적) 내보내기
DELETE FROM `guest`;
INSERT INTO `guest` (`idx`, `name`, `content`, `email`, `homePage`, `visitDate`, `clientIp`) VALUES
	...
	(37, 'btom1234', 'btom1234\r\n처음 다녀갑니다.', '', 'https://', '2026-03-12 08:31:02', '192.168.50.20'),
	(38, 'btom1234', '또 다녀갑니다.\r\n반가워요', '', 'https://', '2026-03-13 08:35:29', '192.168.50.20'),
	(39, 'btom1234', '한번 더 다녀갑니다.', '', 'https://', '2026-03-16 08:39:29', '192.168.50.20'),
	(40, 'btom1234', '다시한번 더 도전합니다.\r\n정회원이 될까요?', '', 'https://', '2026-03-17 08:42:19', '192.168.50.20');
...
-- 테이블 데이터 springgreen.member:~10 rows (대략적) 내보내기
DELETE FROM `member`;
INSERT INTO `member` (`idx`, `mid`, `pwd`, `nickName`, `name`, `gender`, `birthday`, `tel`, `address`, `email`, `homePage`, `job`, `hobby`, `photo`, `content`, `userInfor`, `userDel`, `point`, `level`, `visitCnt`, `startDate`, `lastDate`, `todayCnt`) VALUES
	...
	(6, 'btom1234', '54896261a2325edc257bf555bb11ea4c1f325837274bd57b4908b38ee81d97463977f896', '비톰맨', '비톰', '남자', '2026-03-12 00:00:00', '010-3232-3232', ' / / / ', 'cjsk1126@naver.com', 'https://', '기타', '기타', 'noimage.jpg', '', '공개', 'NO', 130, 2, 0, '2026-03-12 15:44:32', '2026-03-17 10:46:04', 15),
	...
	(12, 'etom1234', '76bde1db0c67a84710f283b5ef8a0927692bbeee9f82eb75efec215b1ff8dfe91164e9af', '이톰맨', '이톰', '여자', '2007-03-17 00:00:00', '010-5454-5454', '31253 /충남 천안시 동남구 병천면 5산단로 357-44 / / ', 'cjsk1126@hanmail.net', 'https://', '기타', '수영/영화감상/기타', 'noimage.jpg', '감사합니다.', '공개', 'NO', 110, 1, 0, '2026-03-17 09:04:29', '2026-03-17 09:04:37', 1);
...
-- 테이블 데이터 springgreen.test3:~0 rows (대략적) 내보내기
DELETE FROM `test3`;
